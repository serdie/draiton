...
Para que la subida de archivos (avatares, facturas, etc.) funcione correctamente, es **imprescindible** configurar las reglas de CORS en tu bucket de Firebase Storage. De lo contrario, el navegador bloqueará las peticiones por seguridad.
