...
export const getRoleBadgeClass = (role: 'free' | 'pro' | 'admin' | 'empresa' | 'employee') => {
  switch (role) {
    ...
    case 'employee': return 'bg-orange-100 dark:bg-orange-500/20 text-orange-800 dark:text-orange-400 border-orange-200 dark:border-orange-500/30';
