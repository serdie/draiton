  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex neumorphism:bg-transparent",
            side === "left"
        ...
        >
          <div
            ...
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow neumorphism:shadow-[var(--light-shadow),var(--dark-shadow)] neumorphism:border-none"
          >
            {children}
          </div>
        </div>
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-primary data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2 group-data-[collapsible=icon]:justify-center [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground neumorphism:border-none neumorphism:shadow-[var(--light-shadow),var(--dark-shadow)] neumorphism:hover:shadow-[var(--light-shadow-inset),var(--dark-shadow-inset)] neumorphism:data-[active=true]:shadow-[var(--light-shadow-inset),var(--dark-shadow-inset)] neumorphism:data-[active=true]:bg-background/50",
        outline:
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  const width = React.useMemo(() => {
    if (typeof window === 'undefined') return '50%'; // Server-side fallback
